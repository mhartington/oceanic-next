...
function! oceanic_next#highlight(base00, base01, base02, base03, base04, base05, base06, base07, red, orange, yellow, green, cyan, blue, purple, brown, white, none) abort
  ...
  call s:hi('VertSplit',                          a:base00, a:base02, '',          '')
  ...
  call s:hi('LspDiagnosticsSignError',            a:red,    '',       '',          '')
  call s:hi('LspDiagnosticsUnderlineError',       '',       '',       'undercurl', '')

  call s:hi('LspDiagnosticsDefaultWarning',       '',       '',       '',          '')
  call s:hi('LspDiagnosticsSignWarning',          a:yellow, '',       '',          '')
  call s:hi('LspDiagnosticsUnderlineWarning',     '',       '',       'undercurl', '')

  call s:hi('LspDiagnosticsDefaultInformation',   '',       '',       '',          '')
  call s:hi('LspDiagnosticsSignInformation',      a:blue,   '',       '',          '')
  call s:hi('LspDiagnosticsUnderlineInformation', '',       '',       'undercurl', '')

  call s:hi('LspDiagnosticsDefaultHint',          '',       '',       '',          '')
  call s:hi('LspDiagnosticsSignHint',             a:cyan,   '',       '',          '')
  call s:hi('LspDiagnosticsUnderlineHint',        '',       '',       'undercurl', '')


  " TreeSitter stuff
  call s:hi('TSInclude',                          a:purple, '',       '',          '')
  call s:hi('TSPunctBracket',                     a:cyan,   '',       '',          '')
  call s:hi('TSPunctDelimiter',                   a:cyan,   '',       '',          '')
  call s:hi('TSPunctSpecial',                     a:cyan,   '',       '',          '')
  call s:hi('TSParameter',                        a:base07, '',       '',          '')
  call s:hi('TSType',                             a:yellow, '',       '',          '')
  call s:hi('TSFunction',                         a:blue,   '',       '',          '')

  call s:hi('TSTagDelimiter',                     a:cyan,   '',       '',          '')
  call s:hi('TSProperty',                         a:base07, '',       '',          '')
  call s:hi('TSMethod',                           a:blue,   '',       '',          '')
  call s:hi('TSParameter',                        a:yellow, '',       '',          '')
  call s:hi('TSConstructor',                      a:base07, '',       '',          '')
  call s:hi('TSVariable',                         a:base06, '',       '',          '')
  call s:hi('TSOperator',                         a:orange, '',       '',          '')
  call s:hi('TSTag',                              a:base07, '',       '',          '')
  call s:hi('TSKeyword',                          a:purple, '',       '',          '')
  call s:hi('TSVariableBuiltin',                  a:red,    '',       '',          '')
  call s:hi('TSLabel',                            a:cyan,   '',       '',          '')

  call s:hi('TSConditional',                      a:purple, '',       '',          '')
  call s:hi('TSNamespace',                        a:base07, '',       '',          '')
  call s:hi('TSSymbol',                           a:green,  '',       '',          '')
  call s:hi('TSException',                        a:red,    '',       '',          '')
