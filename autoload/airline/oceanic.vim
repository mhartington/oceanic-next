...
let g:airline#themes#oceanic#palette = {}
let g:airline#themes#oceanic#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#oceanic#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#oceanic#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#oceanic#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
...
let g:airline#themes#oceanic#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
...
let g:airline#themes#oceanic#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(s:CP1, s:CP2, s:CP3)

" Tabline
let g:airline#themes#oceanic#palette.tabline = {
