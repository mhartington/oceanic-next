...
" {{{ call s::hi(group, fg, bg, gui, guisp)
  ...
  call s:hi('@punctuation.bracket',               s:cyan,   '',       '',          '')
  call s:hi('@punctuation.delimiter',             s:base07, '',       '',          '')
  call s:hi('@parameter',                         s:base07, '',       '',          '')
  call s:hi('@type',                              s:blue,   '',       '',          '')
  call s:hi('@function',                          s:cyan,   '',       '',          '')

  call s:hi('@tag.delimiter',                     s:cyan,   '',       '',          '')
  call s:hi('@property',                          s:yellow, '',       '',          '')
  call s:hi('@method',                            s:blue,   '',       '',          '')
  call s:hi('@parameter',                         s:yellow, '',       '',          '')
  call s:hi('@constructor',                       s:base07, '',       '',          '')
  call s:hi('@variable',                          s:base07, '',       '',          '')
  call s:hi('@operator',                          s:base07, '',       '',          '')
  call s:hi('@tag',                               s:base07, '',       '',          '')
  call s:hi('@keyword',                           s:purple, '',       '',          '')
  call s:hi('@keyword.operator',                  s:purple, '',       '',          '')
  call s:hi('@variable.builtin',                  s:red,    '',       '',          '')
  call s:hi('@label',                             s:cyan,   '',       '',          '')
